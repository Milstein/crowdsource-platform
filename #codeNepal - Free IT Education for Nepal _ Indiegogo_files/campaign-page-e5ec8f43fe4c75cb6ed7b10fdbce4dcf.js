...
(function () {
  ...
  angular.module('indiegogo.campaignPage', [
    'ui.router',
    'header',
    'footer',
    'utils',
  ...
  angular.module('campaignPage.showPage', [
    'templates',
    'utils',
    'ngAnimate',
    'perks',
...
(function() {
  ...
  angular.module('campaignPage.dashboard').directive('pcDashboard', ['i18n', '$state', 'pcDashboard', 'pcCampaign', 'gon', 'browser',
    function (i18n, $state, pcDashboard, pcCampaign, gon, browser) {
      ...
      link: function(scope) {
        scope.i18n = i18n;
        pcDashboard.version = scope.version;
        ...
        scope.inFbAutopostExperiment = gon.in_auto_fb_post_experiment;
      ...
      link: function(scope) {
        ...
        scope.getDonations = function(params) {
          ...
          pcDashboard.getDonations(params).then(function() {
            ...
            scope.updatedAt = pcDashboard.donationsData.date;
  ...
  angular.module('campaignPage.dashboard').factory('pcDashboard', ['$http', '$sce', 'gon', function ($http, $sce, gon) {
    ...
    dashboard.getDonations = function(params) {
      ...
      return $http.get(dashboard.urls.donations_endpoint, {params: params})
        .success(function(response) {
          dashboard.donationsData.date = response.date;
          dashboard.donationsData.pledges = response.pledges;
          dashboard.donationsData.totalPages = Math.ceil(response.total/params.per_page);
        });
    };
  ...
  angular.module('campaignPage.dashboard').directive('pcFunds', ['i18n', 'pcDashboard', function (i18n, pcDashboard) {
    return {
      ...
      link: function(scope) {
        ...
        pcDashboard.getFunds().then(function() {
          scope.showData = true;
          scope.funds = pcDashboard.fundsData.funds;
          scope.updatedAt = pcDashboard.fundsData.date;
        });
      }
    };
  }]);
...
(function() {
  'use strict';
  angular.module('campaignPage.dashboard').directive('pcFundsHeld', ['i18n', 'pcDashboard', function (i18n, pcDashboard) {
    return {
      ...
      link: function(scope) {
        ...
        scope.getHeldDonations = function(params) {
          var defaultParams = { fulfillment_status: "on_hold" };
          ...
          pcDashboard.getDonations(params).then(function() {
            ...
            scope.updatedAt = pcDashboard.donationsData.date;
            scope.pledges = pcDashboard.donationsData.pledges;
            scope.totalPages = _.range(1, pcDashboard.donationsData.totalPages + 1);
          });
        };
...
(function() {
  ...
  angular.module('campaignPage.dashboard').directive('pcTodoItems',
    ['i18n', 'pcDashboard', 'fb', 'gon', 'todoItems', 'twitter', 'gogoEvents', function (i18n, pcDashboard, fb, gon, todoItems, twitter, gogoEvents) {
      return {
        scope: {},
...
(function() {
  ...
  angular.module('campaignPage.life').directive('pcPostUpdate',
                                                    ['pcCampaign', 'i18n', '$http', 'gon',
                                                      function (pcCampaign, i18n, $http, gon) {
    return {
      restrict: 'A',
      scope: {},
      ...
      return {
        ...
        link: function (scope, element, attrs, controller, transclude) {
          ...
          scope.shareFacebook = function() {
            var options = gon.current_account? {account_id: gon.current_account.account_id} : {};
            fb.share(gon.urls.fundraiser_url, options);
          };
        }
      };
    }]);
...
(function () {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignBasicInfo', ['ga', 'campaign', '$state', 'i18n', 'gon', '$rootScope', function (ga, campaign, $state, i18n, gon, $rootScope) {
    return {
      restrict: 'A',
      transclude: false,
      replace: false,
...
(function () {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignContact', ['gon', 'i18n', '$http', '$state', '$rootScope', '$timeout', function (gon, i18n, $http, $state, $rootScope, $timeout) {
    return {
      restrict: 'A',
      scope: {},
      transclude: false,
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignFundingInfo', ['$filter', 'campaign', 'i18n', 'gon', function ($filter, campaign, i18n, gon) {
    return {
      restrict: 'A',
      transclude: false,
      scope: {},
      ...
      link: function(scope, element, attrs,  nullController, transclude) {
        ...
        scope.foreverFundingBlurb = function() {
          return i18n.t("percent_funded_on_end_date_html", {
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignLogin', ['campaign', '$state', 'i18n', function (campaign, $state, i18n) {
    return {
      restrict: 'A',
      scope: {},
      transclude: false,
...
(function () {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignMain', ['campaign', 'gon', function (campaign, gon) {
    return {
      restrict: 'E',
      scope: {},
...
(function () {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignModal', ['$sce', 'browser', function ($sce, browser) {
    return {
      restrict: 'A',
      transclude: false,
      replace: false,
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignPerks', ['campaign', 'i18n', '$sce', 'perkFactory', 'gon', function (campaign, i18n, $sce, PerkFactoryPerk, gon) {
    return {
      restrict: 'A',
      scope: {},
      transclude: false,
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignPitchmedia', ['$sce', 'campaign', 'gon', function ($sce, campaign, gon) {
    return {
      restrict: 'A',
      scope: {},
      transclude: false,
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignStory', ['campaign', 'i18n', function (campaign, i18n) {
    return {
      restrict: 'A',
      scope: {},
      transclude: false,
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignTeamMembers', ['campaign', '$sce', 'i18n', function (campaign, $sce, i18n) {
    return {
      restrict: 'A',
      scope: {},
      transclude: false,
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignTrustPassport', ['campaign', 'i18n', 'gon', '$state', 'browser', function (campaign, i18n, gon, $state, browser) {
    return {
      restrict: 'A',
      scope: {},
      transclude: false,
...
(function () {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('campaignTrustTeaser', ['i18n', '$state', 'browser', function (i18n, $state, browser) {
    return {
      restrict: 'A',
      scope: {},
...
(function() {
  ...
  angular.module('indiegogo.campaignPage').directive('campaignVideo', ['$sce', 'youtube', 'ga', function ($sce, youtube, ga) {
    return {
      restrict: 'A',
      scope: {},
...
(function() {
  'use strict';
  angular.module('indiegogo.campaignPage').directive('collapsable', ['$compile', function ($compile) {
    return {
      restrict: 'E',
      scope: {
        imageUrl: "@",
...
(function () {
  angular.module('indiegogo.campaignPage').factory('campaign', ['$sce', '$http', 'gon', function($sce, $http, gon) {
...
(function () {
  ...
  angular.module('campaignPage.showPage').factory('campaignComments', [
...
(function () {
  ...
  angular.module('campaignPage.showPage').factory('pusherWrapper',
    function() {
      return {
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('campaignShareLinks', [
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('campaignShareModal', [
...
(function () {
  ...
  angular.module("campaignPage.showPage").directive('contributeButtonGaTracking', [
    'ga', 'gon',
    function (ga, gon) {
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopApprovalButton', [
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopCampaignPage', [
    'gon', 'ga', '$window',
    function (gon, ga, $window) {
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopComments', [
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopFunders', [
    '$http', 'gon', 'i18n',
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopGallery', [
    '$http', 'gon', 'i18n', '$sce',
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopProjectFunderCount', [
    'gon', 'campaignPusher',
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopProjectNutshell', [
...
(function() {
  angular.module('campaignPage.showPage').directive('desktopTrustPassport',
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('desktopUpdates', [
...
(function () {
  ...
  angular.module("campaignPage.showPage").directive('earlyContribute', [
    'i18n', '$filter',
...
(function () {
  ...
  angular.module('campaignPage.showPage').provider('storyTabCache', function () {
    var cachedHtml;
...
(function () {
  ...
  angular.module('campaignPage.showPage').directive('videoOverlay', [
    'youtube', '$sce',
  ...
  angular.module('campaignPage.utils').factory('fbAutopost', [
    ...
    function ($http, gon, gogoEvents) {
      ...
      function makeSnapshot() {
        service.snapshot = _.pick(service, 'postingActive', 'frequency');
      }
...
(function () {
  angular.module('campaignPage.utils').factory('todoItems', ['$http', 'gon', 'i18n', function ($http, gon, i18n) {
    ...
    _(['facebook_share', 'twitter_share', 'email_share', 'promotion_program']).each(function(itemName) {
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-automated-facebook-modal.html',
    ...
    '      </p>\n' +
    '    </div>\n' +
    '    <div class="autopostSettingsModal-section autopostSettingsModal-section--frequency">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-dashboard-donations.html',
    ...
    '    {{i18n.t(\'command_center.last_updated_x_ago\', {date: updatedAt})}}\n' +
    '  </span>\n' +
    ...
    '        <td>{{pledge.formatted_amt_gross}}</td>\n' +
    '        <td>{{pledge.email}}</td>\n' +
    '        <td>{{pledge.pledge_name}}</td>\n' +
    '        <td>{{pledge.appearance}}</td>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-dashboard-end-fundraiser-modal.html',
    '<div class="modal pc-end-fundraiser-modal">\n' +
    '  <div class="modal-dialog pc-modal-dialog">\n' +
    '    <a class="pc-modal-close" ng-click="$hide()">\n' +
    '      <span class="i-icon i-glyph-icon-30-close"></span>\n' +
    '    </a>\n' +
    '    <div class="pc-modal-content">\n' +
    '      <h2 class="pc-modal-miniheading pc-endFundraiser-modal-title">{{::i18n.t(\'personal.dashboard.end_fundraiser_modal.title\')}}</h2>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-dashboard-remove-deadline-modal.html',
    '<div class="modal pc-remove-deadline-modal">\n' +
    '  <div class="modal-dialog pc-modal-dialog">\n' +
    '    <a class="pc-modal-close" ng-click="$hide()">\n' +
    '      <span class="i-icon i-glyph-icon-30-close"></span>\n' +
    '    </a>\n' +
    '    <div class="pc-modal-content">\n' +
    '      <h2 class="pc-modal-miniheading pc-removeDeadline-modal-title">{{::i18n.t(\'personal.dashboard.remove_deadline_modal.title\')}}</h2>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-dashboard.html',
    ...
    '  <a class="i-tab" ui-sref="manage" ng-class="{\'i-selected pc-selected\' : isCurrentTab(\'manage\')}">\n' +
    '    <span>{{::i18n.t(\'manage\')}}</span>\n' +
    '  </a>\n' +
    '  <a class="i-tab" ui-sref="donations" ng-class="{\'i-selected pc-selected\' : isCurrentTab(\'donations\')}">\n' +
    '    <span>{{::i18n.t(\'personal.donations\')}}</span>\n' +
    '  </a>\n' +
    '  <a class="i-tab" ui-sref="funds" ng-class="{\'i-selected pc-selected\' : isCurrentTab(\'funds\')}">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-funds-held.html',
    ...
    '      <a id="page-{{page}}-link" ng-click="getHeldDonations({page: page})" ng-class="{\'pc-selected-page\' : isCurrentPage(page)}">\n' +
    '        {{page}}\n' +
    '      </a>\n' +
    '    </li>\n' +
    '  </ul>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-funds-tab.html',
    '<div class="pc-dashboard-funds" pc-funds>\n' +
    '</div>\n' +
    '<div class="pc-dashboard-funds-held" pc-funds-held>\n' +
    '</div>\n' +
    '');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-funds.html',
    ...
    '</div>\n' +
    '\n' +
    '<table class="table" ng-if="showData">\n' +
    '  <thead>\n' +
    '    <tr>\n' +
    '      <th></th>\n' +
    '      <th ng-repeat="fundsData in funds">{{fundsData.contribution_method}}</th>\n' +
    '    </tr>\n' +
    '  </thead>\n' +
    '\n' +
    '  <tbody>\n' +
    '    <tr><th>{{::i18n.t(\'command_center.raised_to_date\')}}</th><td ng-repeat="fundsData in funds" class="number-cell">{{fundsData.total_raised_formatted}}</td></tr>\n' +
    '    <tr><th>{{::i18n.t(\'command_center.payment_processor_fees_deducted\')}}</th><td ng-repeat="fundsData in funds" class="string-cell">{{fundsData.transaction_fees}}</td></tr>\n' +
    '    <tr><th>{{::i18n.t(\'command_center.bank_delivery_fees\')}}</th><td ng-repeat="fundsData in funds" class="string-cell">{{fundsData.delivery_fees}}</td></tr>\n' +
    '    <tr><th>{{::i18n.t(\'command_center.disbursed_to_date\')}}</th><td ng-repeat="fundsData in funds" class="string-cell">{{fundsData.total_raised_disbursed}}</td></tr>\n' +
    '    <tr><th>{{::i18n.t(\'command_center.not_yet_disbursed\')}}</th><td ng-repeat="fundsData in funds" class="string-cell">{{fundsData.total_raised_not_yet_disbursed}}</td></tr>\n' +
    '    <tr><th>{{::i18n.t(\'command_center.funds_disbursed_to\')}}</th><td ng-repeat="fundsData in funds" class="linkable-cell" ng-bind-html="fundsData.destination"></td></tr>\n' +
    '    <tr><th>{{::i18n.t(\'command_center.when_to_expect_your_funds\')}}</th><td ng-repeat="fundsData in funds" class="linkable-cell" ng-bind-html="fundsData.description"></td></tr>\n' +
    '  </tbody>\n' +
    '</table>\n' +
    '');
}]);
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-manage-tab.html',
    ...
    '    <div pc-automated-facebook-updates ng-if="inFbAutopostExperiment" class="pc-dashboard-mainCol-item pc-dashboard-section"></div>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-recent-donations.html',
    ...
    '</div>\n' +
    '<div class="pc-dashboard-section-body pc-recentDonations">\n' +
    '  <div class="pc-recentDonation" ng-repeat="donation in recentDonations">\n' +
    '    <div class="pc-recentDonation-image">\n' +
    '      <img class="pc-recentDonation-imagePhoto" ng-src="{{donation.photo_url}}" />\n' +
    '      <div class="pc-recentDonation-imageAmt">{{donation.amount}}</div>\n' +
    '    </div>\n' +
    '    <div class="pc-recentDonation-mainCol">\n' +
    '      <div class="pc-recentDonation-name">{{donation.name}}</div>\n' +
    '      <div class="pc-recentDonation-amount" ng-bind-html="donationAmountHtml(donation.amount)"></div>\n' +
    '      <div class="pc-recentDonation-time">{{donation.timestamp}}</div>\n' +
    '      <div class="pc-recentDonation-comment" ng-if="donation.comment">{{donation.comment}}</div>\n' +
    '    </div>\n' +
    '  </div>\n' +
    '</div>\n' +
    '<div class="pc-dashboard-section-footer">\n' +
    '  <a href="" ui-sref="donations">{{::i18n.t(\'personal.fundraiser_dashboard.view_complete_donation_list\')}}</a>\n' +
    '</div>\n' +
    '');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/pc-todo-items.html',
    ...
    '        <a class="pc-cta-basic pc-cta--todoItem pc-dashboard-todoItem-cta pc-cta--additionalItem robert-link" ng-click="completePromotionProgramCallback()" ng-href="{{urls.promotion_program_url}}" target="_blank">\n' +
    '          {{::i18n.t(\'join\')}}\n' +
    '        </a>\n' +
    '      </div>\n' +
    '    </div>\n' +
    ...
    '</div>\n' +
    '\n' +
    '<div class="pc-dashboard-section-showTips hidden-xs" ng-if="showPromotionProgramTodoItem">\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/campaign-funding-info.html',
    ...
    '    ng-bind-html="campaign.collected_funds + campaign.forever_funding_collected_funds | iggCurrency : campaign.currency.iso_num : \'html\'">\n' +
    '  </span>\n' +
    '  <span class="i-goal">\n' +
    '    {{::i18n.t("raised_of")}}\n' +
    ...
    '<div\n' +
    '  ng-if="!campaign.isInDemand()"\n' +
    '  class="i-funding-progress-container">\n' +
    ...
    '    </span>\n' +
    '    <span ng-if="campaign.isInDemand()" ng-bind-html="foreverFundingBlurb()"></span>\n' +
    '  </div>\n' +
    '</div>\n' +
    '\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('views/share-facebook.html',
    ...
    '          </div>\n' +
    '        </div>\n' +
    '        <div class="pc-shareWizard-content-middle-autoFb" ng-if="inFbAutopostExperiment && subdomain === \'life\'">\n' +
